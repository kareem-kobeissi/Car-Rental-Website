...
<body>
  <header>
    ...
    <nav class="navigation">
      <ul>
        ...
        <li><a href="officeRegistration.php"><i class="fas fa-car"></i> Office Registration</a></li>
        <li><a href="carRegistration.php"><i class="fas fa-car"></i> Car Registration</a></li>
        <li><a href="control.php"><i class="fas fa-chart-bar"></i> Control</a></li>
  ...
  <section class="admin">
    <div>
      <h1 id="adminHeading"> </h1>
      <h3 id="adminSubHeading"></h3>
    </div>
  </section>
