...
<body>
  <header>
    <a href="customerHome.php" class="logo">Home</a>

    <nav class="navigation">
      <ul>
        <li><a href="AvailableCars.php"><i class="far fa-calendar-alt"></i>Available Cars</a></li>
  ...
  <section class="Customer">
    <div>
      <h1 id="customerHeading"> </h1>
      <h3 id="customerSubHeading"></h3>
    </div>
  </section>
